		...
		<div class="menu-bg">
			<div class="menu">
				<div class="avatar-cover">
					<!-- <img id="avatar" src="https://cdn.discordapp.com/avatars/69408702452469760/a_6fd7d46876ee660ad15d2337f4e2ad8b.gif?size=1024" style="border-radius: 100%;width: 64px;height: 64px;">
					<span class="avatar-username"><?php echo  $_SESSION['users_email']?></span>
					<span class="avatar-status"><i class="fa fa-circle" aria-hidden="true"></i>Online</span>
					<label class="edit_avatar">
						<i class="fa fa-camera" aria-hidden="true"></i>
						<input class="avatarinput" type="file">
					</label>
					<span id="remove_avatar">
				...
				<ul>
					...
					if ($isAdmin) {
						...
						foreach ($menus as $menu) {
							...
							if (!empty($menu['subpage'])) {
								$subpage = "&amp;p=" . $menu['subpage'];
								$button = $menu['subpage'];
								if (isset($_GET['p']) and $_GET['p'] == $menu['subpage']) $menu_link_class = 'admin_menu_link_selected';
								else $menu_link_class = 'admin_menu_link';
							} else {
								$subpage = "";
								$button = $menu['module'];
								if (isset($_GET['m']) and $_GET['m'] == $menu['module']) $menu_link_class = 'admin_menu_link_selected';
								else $menu_link_class = 'admin_menu_link';
							}
					...
					?>
					<li>
						<a href="?m=user_admin&amp;p=edit_user&amp;user_id=<?php echo $_SESSION['user_id'] ?>" <?php if (isset($_GET['p']) and $_GET['p'] == "edit_user") echo 'class="user_menu_link_selected"';
																												else echo 'class="user_menu_link"';
